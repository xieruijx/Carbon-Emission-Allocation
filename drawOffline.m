...
figure;
plot(0:Num_T,[0;income(:,1)],0:Num_T,[0;Revenue_Off_Theo],0:Num_T,[0;Revenue_Tra_Theo],'LineWidth',2);
legend('Proposed','Offline','Traditional real-time','location','northwest');
xlabel('Time (h)');
